...
let
  sources = {
    ...
    "@types/codemirror-0.0.91" = {
      ...
      version = "0.0.91";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/codemirror/-/codemirror-0.0.91.tgz";
        sha512 = "FZcfBNjhVc6slo6RbtbCqYa+KTQa9sykV5OdRLqd3FeMPddVLFuqSR3KNZUbzU9qoEBudBZX0nbItJ52ml37KA==";
      };
    };
    ...
    "@types/node-14.0.6" = {
      ...
      version = "14.0.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-14.0.6.tgz";
        sha512 = "FbNmu4F67d3oZMWBV6Y4MaPER+0EpE9eIYf2yaHhCWovc1dlXCZkqGX4NLHfVVr6umt20TNBdRzrNJIzIKfdbw==";
      };
    };
    ...
    "codemirror-5.53.2" = {
      ...
      version = "5.53.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/codemirror/-/codemirror-5.53.2.tgz";
        sha512 = "wvSQKS4E+P8Fxn/AQ+tQtJnF1qH5UOlxtugFLpubEZ5jcdH2iXTVinb+Xc/4QjshuOxRm4fUsU2QPF1JJKiyXA==";
      };
    };
    ...
    "ts-loader-7.0.2" = {
      ...
      version = "7.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts-loader/-/ts-loader-7.0.2.tgz";
        sha512 = "DwpZFB67RoILQHx42dMjSgv2STpacsQu5X+GD/H9ocd8IhU0m8p3b/ZrIln2KmcucC6xep2PdEMEblpWT71euA==";
      };
    };
    "tslib-1.13.0" = {
      name = "tslib";
...
in
{
  "github-bot-github:smogon/GitHub-Bot" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "4c6011991fce328f033073b1668f1068d3ba0f52";
      sha256 = "908849e855fafc727431e888d04707738e0355865bb99ede12f3b2291fe584fe";
    };
    dependencies = [
      sources."@types/caseless-0.12.2"
      sources."@types/escape-html-0.0.20"
      sources."@types/node-14.0.6"
  ...
  "pastebinrun-git+https://gitlab.com/pastebin.run/server.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "169cef294dce6c85046ba27fada32d8dd56a8700";
      sha256 = "e46660247e8e5c1f257f544d1e3f445636a39bf8b6763441cb94da9f835840ec";
    };
    dependencies = [
      sources."@types/codemirror-0.0.91"
