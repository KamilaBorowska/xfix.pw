...
let
  sources = {
    ...
    "codemirror-5.50.0" = {
      ...
      version = "5.50.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/codemirror/-/codemirror-5.50.0.tgz";
        sha512 = "32LAmGcBNhKtJP4WGgkcaCVQDyChAyaWA6jasg778ziZzo3PWBuhpAQIJMO8//Id45RoaLyXjuhcRUBoS8Vg+Q==";
      };
    };
    ...
    "style-loader-1.1.1" = {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/style-loader/-/style-loader-1.1.1.tgz";
        sha512 = "oIVF12trRq0od4Yojg7q0K3Lq/O6Ix/AYgVosykrVg+kWxxxUyk8KhKCCmekyGSUiVK1xxlAQymLWWdh6S9lOg==";
      };
    };
...
in
{
  ...
  "pastebinrun-git+https://gitlab.com/pastebin.run/server.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "44299b2998c08237511e609baa0a73f607a5e827";
      sha256 = "ecb50b15c552c3b37d31680fbbc049dc149f9944bdb9b93d4944f28fb38bcde5";
    };
    dependencies = [
