...
let
  sources = {
    ...
    "webpack-stats-plugin-0.3.0" = {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/webpack-stats-plugin/-/webpack-stats-plugin-0.3.0.tgz";
        sha512 = "4a6mEl9HLtMukVjEPY8QPCSmtX2EDFJNhDTX5ZE2CLch2adKAZf53nUrpG6m7NattwigS0AodNcwNxlu9kMSDQ==";
      };
    };
    "websocket-1.0.30" = {
      name = "websocket";
...
in
{
  ...
  "pastebinrun-git+https://gitlab.com/pastebin.run/server.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "70ab802f433aadd4ba4be61410b3386ed9eb65a9";
      sha256 = "2926ddff4b1c3fccc4004d1531e46e7a93ae7e9bc81dcbe9fbbfe032402aa82d";
    };
    dependencies = [
      ...
      sources."webpack-stats-plugin-0.3.0"
      sources."which-1.3.1"
